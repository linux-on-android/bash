...
topdir = .
BUILD_DIR = /home/crixec/workspace/cross/bash-4.4-rc2
top_builddir = /home/crixec/workspace/cross/bash-4.4-rc2
srcdir = .
...
CFLAGS = -static -O2 -fPIE -Wno-parentheses -Wno-format-security
...
LDFLAGS = -static -O2 -fPIE -static -L./lib/termcap $(STATIC_LD) $(LOCAL_LDFLAGS) $(PROFILE_FLAGS) $(CFLAGS)
